...
class Settings(BaseSettings):
    ...
    GPU_MEMORY_FREE_THRESHOLD_GB: int = Field(default=20, env="GPU_MEMORY_FREE_THRESHOLD_GB")
    ...
    # 训练配置
    DEFAULT_TRAINING_TIMEOUT: int = Field(default=86400, env="DEFAULT_TRAINING_TIMEOUT")  # 24小时
